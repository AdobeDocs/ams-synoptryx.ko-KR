---
title: Synoptryx를 통한 인프라 모니터링
description: Synoptrix Infrastructure Monitoring을 사용하여 AEM Managed Services 설치 공간에서 호스트 수준 시스템, 네트워크, 프로세스 및 스토리지 지표를 검토할 수 있습니다.
feature: Operations
role: Admin
